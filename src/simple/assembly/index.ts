...
//near call $CONTRACT specific_flight '{"id":2354046042}' --accountId zzeyns.testnet
...
//near call $CONTRACT delete_specific '{"id":1284343803}' --accountId zzeyns.testnet
...
//near call $CONTRACT Update '{"id":3111645745,"updates":{"text":"Moon and Back","cost":"560000","capsul":5,"destination":"Moon","departure":"İstanbul","max_seat":7}}' --accountId zzeyns.testnet
